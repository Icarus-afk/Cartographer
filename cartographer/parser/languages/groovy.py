...
class GroovyParser(BaseParser):
    def _build_language(self) -> Language:
        return Language(tree_sitter_groovy.language())
    ...
    def _parse_top(self, node: Node, source: bytes, file_path: str) -> ParsedEntity | None:
        ...
        if node.type == "method_declaration":
            ...
            return ParsedEntity(
                ...
                location=CodeLocation(**loc), relationships=relationships,
            )
                ...
                if child.type == "method_declaration":
                    ...
                    if name_node:
                        ...
                        children.append(ParsedEntity(
                            kind=EntityKind.METHOD, name=mname,
                            location=CodeLocation(**mloc), relationships=mrelationships,
                        ))
